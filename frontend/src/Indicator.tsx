  ...
  return (
    <div className="text-black flex flex-row w-screen h-screen overflow-hidden bg-secondary">
      ...
      <div className="flex pl-50 flex-col items-center justify-center flex-nowrap">
        ...
        />
        <div className="">
          <input type="checkbox" checked={ownedStock} onChange={(e) => setOwnedStock(e.target.checked)} />
        ...
        {result && (
          <div className="mt-4 p-4 border rounded">
            ...
            <p>
              <strong>Trade Decision:</strong> {result.trade_decision}
            </p>
            ...
            <p>
              <strong>EMA:</strong> {result.EMA}
            </p>
            <p>
              <strong>MACD:</strong> {result.MACD}
            </p>
            <p>
              <strong>Bollinger Bands:</strong> Low: {result.Bollinger_Bands.Low}, Mid: {result.Bollinger_Bands.Mid},
              Up: {result.Bollinger_Bands.Up}
            </p>
            <p>
              <strong>OBV:</strong> {result.OBV}
            </p>
          </div>
        )}
      </div>
